function loss = eseloss(x,y,xy,varargin)
%eseloss Multisensory loss of an exhaustive search effect.
...
%   them.
%
%   [...] = ESELOSS(...,'PARAM1',VAL1,'PARAM2',VAL2,...) specifies
...
%
%   See also ESELOSS3, WAITMODEL, ESEDEFICIT, TPERMTEST, EFFECTSIZE.
%
