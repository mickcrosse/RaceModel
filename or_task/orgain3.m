function [gain,Fdiff,t] = orgain3(x,y,z,xyz,p,varargin)
...
%   Z and XYZ can have different lengths.This function treats NaNs as
...
%
%   [...] = ORGAIN3(...,P) uses the intervals P to generate CDFs. P is a
...
%
%   [...,T] = ORGAIN3(...) returns the time intervals used to compute the
