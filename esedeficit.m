function [Demp,Dpred] = esedeficit(x,y,xy,varargin)
%esedeficit Multisensory deficit of an exhaustive search effect.
%   DEMP = ESEDEFICIT(X,Y,XY) returns the empirical deficit of an
...
%   unisensory RT distributions X and Y, and the bisensory RT distribution
%   XY (Otto et al., 2013). X, Y and XY are not required to have an equal
%   number of observations. This function treats NaNs as missing values,
%   and ignores them.
%
%   [...,DPRED] = ESEDEFICIT(...) returns the predicted benefit of an ESE,
...
%   probability of X and Y (Otto et al., 2013).
%
%   [...] = ESEDEFICIT(...,'PARAM1',VAL1,'PARAM2',VAL2,...) specifies
...
%
%   See also ESEDEFICIT3, WAITMODEL, ESELOSS, TPERMTEST, EFFECTSIZE.
%
